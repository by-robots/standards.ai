...
<!-- This agent inherits the session's model. Review quality depends on it. If
     you routinely work on a smaller model, pin a stronger one by adding a
     `model:` line to the frontmatter above. -->
