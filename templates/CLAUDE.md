...
- Do not commit or push unless asked. Finishing a change is not authorisation to commit it.
- Do not commit directly to the default branch. If asked to commit while on it, create a branch first.
